...
TODO:
1. Поменять местами minRand и maxRand (проект Random)
2. Сдвинуть массив на заданное число элементов (проект Shift);
3. Десятичное число, введенное с клавиатуры перевести в двоичную систему счисления;
4. Десятичное число, введенное с клавиатуры перевести в шетнадцатеричную систему счисления;
5. Как следует отдохнуть!!!
6. Посмотреть "TheMatrix"!!!
